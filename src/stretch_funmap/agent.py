...
class FakeRobot:
    ...
    def lookup_transform(self, target_frame, source_frame):
        ...
        # return tf
        return tree.lookup_transform(target_frame, source_frame).matrix
...
class Agent:
    ...
    def __init__(self, robot=FakeRobot()):
        self.robot = robot
        self.mapper = ma.HeadScan(voi_side_m=16.0)

    def perform_head_scan(self):
        self.mapper.execute_full(self.robot, fast_scan=False)
